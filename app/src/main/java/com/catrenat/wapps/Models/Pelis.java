...
public class Pelis implements Serializable {
    ...
    public Pelis(String name, String imagePath, String category, String sagas, ArrayList<String> genres, String sinopsis, String youtubeUrl, ArrayList<String> platform, ArrayList<String> platformUrl) {
        this.name = name;
    ...
    public void setSagas(String sagas) {
        this.sagas = sagas;
    }
